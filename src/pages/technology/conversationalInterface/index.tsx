      ...
      <Layout>
        ...
        >
          ...
          <Text my="20px" color="#30233D" fontSize={{ base: "1rem", md: "1.688rem" }} >
            Interface conversacional é um software capaz de receber mensagens<br />
            escritas ou por voz, interpretar seu conteúdo e oferecer respostas <br />
            adequadas, sem fazer com que seu cliente precise instalar um novo <br />
